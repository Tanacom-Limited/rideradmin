...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $sql_new = "SELECT statut FROM tbl_request WHERE id_conducteur=$id_driver AND id_user_app=$id_user_app ORDER BY id DESC LIMIT 1";
        $result_new = mysqli_query(DB_API::$conn, $sql_new);
