...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($updatedata > 0) {
        ...
        $query = "select fcm_id from tbl_driver where fcm_id<>'' and id=$id_user";
        ...
        // Get user info
        $query = "select u.fcm_id,u.id,u.nom,u.prenom,u.email from tbl_request r, tj_user_app u where r.id_user_app=u.id and r.id=$id_requete";
        $result = mysqli_query(DB_API::$conn, $query);
