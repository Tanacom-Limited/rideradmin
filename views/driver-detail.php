                                    ...
                                    <div class="user-profile" style="width:100%;">
                                        <div class="profile-img" style="width:20%;">
                                            <img class="profile-pic"
                                                 ...
                                                 alt="user" style="width:300px;height:300px;"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="" class="label-detail-title"><?php echo $brand; ?>
                                        :</label> <?php echo $tab_driver_vehicle_info[0]['brand']; ?>
                                </div>
                                <div class="col-md-12">
                                    <label for="" class="label-detail-title"><?php echo $model; ?>
                                        :</label> <?php echo $tab_driver_vehicle_info[0]['model']; ?>
                                </div>
                                <div class="col-md-12">
                                    <label for="" class="label-detail-title"><?php echo $color; ?>
                                        :</label> <?php echo $tab_driver_vehicle_info[0]['color']; ?>
                                </div>
                                <div class="col-md-12">
                                    <label for="" class="label-detail-title"><?php echo $numberplate; ?>
                                        :</label> <?php echo $tab_driver_vehicle_info[0]['numberplate']; ?>
                                </div>
                                <div class="col-md-12">
                                    <label for="" class="label-detail-title"><?php echo $number_of_passenger; ?>
                                        :</label> <?php echo $tab_driver_vehicle_info[0]['passenger']; ?>
                                </div>
                                <div class="col-md-12">
                                    <a href="../models/action.php?id_conducteur_activer=<?php echo $_GET['id_conducteur']; ?>"
                                       class="btn btn-success btn-sm" data-toggle="tooltip"
                                       data-original-title="Activate"> <?php echo $enable_account; ?> <i
