                                    ...
                                    for ($i = 0; $i < count($tab_type_vehicule); $i++) {
                                        echo '
                                                        <tr>
                                                            ...
                                                            <td width="10%"><img width="100%" src="../public/assets/images/type_vehicle/' . $tab_type_vehicule[$i]['image'] . '" alt=""></td>
                                        ...
                                        <button type="button" onclick="modTypeVehicle(' . $tab_type_vehicule[$i]['id'] . ');" class="btn btn-warning btn-sm" data-original-title="Modifiy" data-toggle="modal" data-target="#type-vehicule-mod"><i class="fa fa-pencil"></i></button>
                                        
                                        <a href="../controller/action.php?id_type_vehicule=' . $tab_type_vehicule[$i]['id'] . '" class="btn btn-danger btn-sm" data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-trash"></i> </a>
...
<script>
    function modTypeVehicle(id_type) {
        $.ajax({
